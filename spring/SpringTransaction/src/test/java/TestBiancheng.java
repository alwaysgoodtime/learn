 ...
 */
public class TestBiancheng {

    AccountService accountService;

    @Before
    public void before() {
        ApplicationContext ac = new ClassPathXmlApplicationContext("beanBianchengTransaction.xml");
        accountService = ac.getBean("accountService2", AccountService.class);
    }
