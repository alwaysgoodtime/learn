...
public class Number6 {
    public static void main(String[] args) {
        ...
        int[] ints = { 3, 3, 3, 3, 3, 3, 3, 3, 3, 0, 2};
...
class Solution6s {
    public int minNumberInRotateArray(int[] array) {
        ...
        //特殊情况，旋转所有的元素，所以第一个为最小，而下面的二分法都是依赖中值与第一个数的比值来确认如何二分的，这样会导致出问题
    ...
    private int find(int[] array, int start, int end) {
        if (start < end) {
            ...
            if (array[middle] < array[0]) {
                ...
                return beforeDiff < afterDiff ? find(array, start, middle) : find(array, middle + 1, end);
            } else {
